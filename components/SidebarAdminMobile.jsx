...
const SidebarAdminMobile = ({ setBurgerIsOpen }) => {
  ...
  return (
    <div className="font-rubik text-sm md:text-base absolute top-[80px] left-[0px] black_opacity w-full min-h-[calc(100vh-69px)] md:h-[calc(100vh-80px)] z-40 unselectable">
      <div className="w-[300px] min-h-[calc(100vh-60px)] bg-neutral-100 dark:bg-neutral-900 flex flex-col items-start shadow-lg">
